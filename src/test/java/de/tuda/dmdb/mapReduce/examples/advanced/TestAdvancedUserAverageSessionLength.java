...
public class TestAdvancedUserAverageSessionLength extends TestCase {
  /**
   * Runs UserAverageSessionLength for multiple partitions with multiple records each consisting of
   * random data.
   */
  @Test
