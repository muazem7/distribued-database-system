...
public abstract class SendBase extends UnaryOperator {
  ...
  protected Map<Integer, String> nodeMap; // map containing connection information to establish
                                          // connection to other
  // peers
   ...
   *        record to
   */
  public SendBase(Operator child, int nodeId, Map<Integer, String> nodeMap,
