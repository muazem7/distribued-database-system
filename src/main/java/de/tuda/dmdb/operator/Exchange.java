...
public abstract class Exchange extends UnaryOperator {
  ...
  protected Map<Integer, String> nodeMap; // Map of the form <NodeId:"IP:port"> containing
  ...
  protected Function<AbstractRecord, List<Integer>> distributionFunction; // function that will be
                                                                          // used by the send
   ...
   */
  public Exchange(Operator child, int nodeId, Map<Integer, String> nodeMap, int listenerPort,
