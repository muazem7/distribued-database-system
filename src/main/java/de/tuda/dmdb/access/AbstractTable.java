...
public abstract class AbstractTable {
  ...
  protected List<RecordIdentifier> rowNumMapping = new ArrayList<RecordIdentifier>(); // maps a
                                                                                      // rowID to a
                                                                                      // record in
                                                                                      // the table
  ...
  public List<AbstractRecord> getRecordFromRowNum(List<Integer> rowNums) {
    List<AbstractRecord> resultList = new ArrayList<AbstractRecord>(); // list to store looked up
                                                                       // Records
