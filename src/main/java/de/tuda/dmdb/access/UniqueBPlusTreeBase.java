...
public abstract class UniqueBPlusTreeBase<T extends AbstractSQLValue>
  ...
  protected AbstractRecord leafRecPrototype; // leaf record: [keyValue: T, pageNumber: SQLInteger,
                                             // slot number:
  // SQLInteger]

  protected AbstractIndexElement<T> root; // root index element

  protected Map<Integer, AbstractIndexElement<T>> indexElements = new HashMap<>(); // map
                                                                                   // (pageNumber,
                                                                                   // indexElement)
