...
public class CatalogManager {
   ...
   */
  public static AbstractTable createTable(Table tableDesc, Vector<Attribute> attributes,
      Vector<DataType> types, Vector<Attribute> primaryKeys) {
   ...
   */
  public static AbstractIndex createUniqueIndex(Index indexDesc, Table tableDesc,
      Attribute attDesc) {
