...
public enum EnumSQLType {
  SqlInteger(new SQLInteger()), SqlBigInteger(new SQLBigInteger()), SqlVarchar(
      new SQLVarchar(255)), SqlNull(
          new SQLNull()), SqlDouble(new SQLDouble()), SqlRowIdentifier(new SQLRowIdentifier());
