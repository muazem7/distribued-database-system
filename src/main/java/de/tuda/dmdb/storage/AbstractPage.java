...
public abstract class AbstractPage {
  ...
  protected int offsetEnd = data.length - HEADER_SIZE; // offset for next variable length value
                                                       // (from page end)
  ...
  public boolean equals(Object o) {
    ...
    return slotSize == that.slotSize && numRecords == that.numRecords && offset == that.offset
        && offsetEnd == that.offsetEnd && pageNumber == that.pageNumber
