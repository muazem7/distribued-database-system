...
public abstract class MapReduceOperator extends UnaryOperator {
  ...
  public static final int KEY_COLUMN = 0; // key will be stored in this column of a record, ie.
                                          // record.getValue(KEY_COLUMN) will
  // return the key
  public static final int VALUE_COLUMN = 1; // value will be stored in this column of a record, ie.
                                            // record.getValue(VALUE_COLUMN) will
  // return the value
