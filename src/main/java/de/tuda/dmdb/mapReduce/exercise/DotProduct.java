...
public class DotProduct implements BaseMapReduceExercise {
  public static class TokenizerMapper
    ...
    public void map(SQLInteger key, SQLInteger value, Queue<AbstractRecord> outList) {
      ...
      newRecord.setValue(MapReduceOperator.KEY_COLUMN, new SQLInteger(one));
      newRecord.setValue(MapReduceOperator.VALUE_COLUMN,
          new SQLInteger(value.getValue() * key.getValue()));
